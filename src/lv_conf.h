...
#define LV_FONT_CUSTOM_DECLARE          LV_FONT_DECLARE(AmericanCaptain18) \
                                        LV_FONT_DECLARE(AmericanCaptain28) \
                                        LV_FONT_DECLARE(AmericanCaptain36) \
                                        LV_FONT_DECLARE(AmericanCaptain48) \
                                        LV_FONT_DECLARE(AmericanCaptain80) \
                                        LV_FONT_DECLARE(AmericanCaptain240) \
                                        LV_FONT_DECLARE(AmericanCaptain260) \
                                        LV_FONT_DECLARE(AmericanCaptain280) \
